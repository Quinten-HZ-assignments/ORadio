...
def switchOn():
		print("-----------------------------Switch on-------------------------------", datetime.now().strftime("%d/%m/%Y %H:%M:%S"))
#		print(Switch_sel1.value)
	 	if Switch_sel1.value >0: Radio_state.playL1()
	 	if Switch_sel2.value >0: Radio_state.playL2()
	 	if Switch_sel3.value >0: Radio_state.playL3()
	 	if Switch_sel4.value >0: Radio_state.playL4()
#----------Switch off with switch-------------------------
def switchOff():
        Radio_state.switchOff()
        print("-----------------------------Switch off-------------------------------", datetime.now().strftime("%d/%m/%Y %H:%M:%S"))
...
print("-----------------------------First power on-------------------------------", datetime.now().strftime("%d/%m/%Y %H:%M:%S"))
...
while True:
     try:
        ...
        if n == 100:
                n = 0
                checkMPC()  # check Mpc status every 100 cycles, just in case, switch to offline
#               Reset_Touch()
